    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if class_name_count in s:
                ...
                print(l)
                if int(l) > 10:
                    cv2.putText(im0, "Street is congestion", (0,80), cv2.FONT_HERSHEY_COMPLEX,1,(0,0,255), 2, cv2.LINE_AA)
                elif 5 <= int(l) <= 10:
                    cv2.putText(im0, "Possible traffic congestion", (0,80), cv2.FONT_HERSHEY_COMPLEX,1,(0,0,255), 2, cv2.LINE_AA)
                else:
                    cv2.putText(im0, "Traffic is flowing smoothly", (0,80), cv2.FONT_HERSHEY_COMPLEX,1,(0,0,255), 2, cv2.LINE_AA)
                    
                cv2.putText(im0, "Number of vehicles: " + l + class_name_count, (0, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (255,255,100), 2, cv2.LINE_AA)
